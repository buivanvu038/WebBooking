                ...
                <div className='home-header-container'>
                    <div className='home-header-content'>
                        ...
                        <div className='right-content'>
                            ...
                            <div className={language === LANGUAGES.VI ? 'language-VI active' :'language-VI'}><span onClick={()=>this.chanlanguage(LANGUAGES.VI)}>VN</span></div>
                            <div className={language === LANGUAGES.EN ? 'language-EN active' :'language-EN'}><span onClick={()=>this.chanlanguage(LANGUAGES.EN)}>EN</span></div>
                        </div>
                    </div>
                </div>
